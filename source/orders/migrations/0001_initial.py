    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tax', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, validators=[products.validators.validate_price], verbose_name='سعر التوصيل')),
                ('order_number', models.IntegerField(db_index=True, default=0, verbose_name='رقم الأوردر')),
