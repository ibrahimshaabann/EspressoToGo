    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, db_index=True, max_length=20, null=True, unique=True, validators=[users.validators.valid_phone_number], verbose_name='رقم التليفون')),
