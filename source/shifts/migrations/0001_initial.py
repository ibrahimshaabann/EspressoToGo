    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_costs', models.DecimalField(decimal_places=2, max_digits=9, verbose_name='اجمالي التكلفة')),
                ('net_profit', models.DecimalField(decimal_places=2, max_digits=9, verbose_name='صافي الربح')),
                ('time_duration', models.DurationField(blank=True, null=True, verbose_name='مدة الشيفت')),
